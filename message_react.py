...
async def send_success_message(message):
    await message.channel.send('>>> Đã bật auto react cho **{}** <:OK:778028306699124797>, gõ **!stop** để dừng'.format(message.author.display_name))


async def send_stop_message(message):
    await message.channel.send('>>> Đã tắt auto react cho **{}** <:OK:778028306699124797>'.format(message.author.display_name))
